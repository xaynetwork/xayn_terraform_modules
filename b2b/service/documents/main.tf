...
module "service" {
  ...
  environment = merge({
    ...
    local.sagemaker_enabled && try(var.sagemaker_endpoint.prefix_query, null) != null ? { XAYN_WEB_API__EMBEDDING__PREFIX__QUERY = var.sagemaker_endpoint.prefix_query } : {},
    local.sagemaker_enabled && try(var.sagemaker_endpoint.prefix_snippet, null) != null ? { XAYN_WEB_API__EMBEDDING__PREFIX__SNIPPET = var.sagemaker_endpoint.prefix_snippet } : {},
