...
data "aws_iam_policy_document" "assume_role_api_gateway_for_cloudwatch" {
  statement {
    effect  = "Allow"
...
resource "aws_iam_role" "api_gateway_cloudwatch" {
  ...
  assume_role_policy = data.aws_iam_policy_document.assume_role_api_gateway_for_cloudwatch.json
  tags               = var.tags
}
